...
class DatasetLoadingTask(BaseDatasetLoadingTask):
    ...
    This task extends the base dataset loading with physics-agent-specific
    ...
    def _update_context(
        ...
        """Update context with physics-agent-specific fields.
        ...
        # Add physics-agent specific field
