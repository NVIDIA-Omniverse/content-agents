...
def test_legacy_render_nvcf_async_module_aliases_remote_helpers() -> None:
    ...
    assert (
        render_nvcf_async.get_global_nvcf_render_limit
        is render_remote_async.get_global_nvcf_render_limit
    )
    assert (
        render_nvcf_async.global_nvcf_render_slot
        is render_remote_async.global_nvcf_render_slot
    )
